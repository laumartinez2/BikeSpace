var map,
    ...
    icons = {
        ...
        reservables: {
            icon: 'assets/img/parking-favorito.png'
        }
    };
...
function initAutocomplete() {
            ...
            marker.addListener('click', function() {
                ...
                infowindow.setOptions({
                    content: "<div class='text-marker'><h2>" + value.parking + "</h2>" +
                        ...
                        "<p>Precio: <b>" + value.precio + "</b></p>" +
                        "<p>Nivel de seguridad: <b>" + value.niveldeseguridad + "</b></p>" +
                        "<button onclick=window.location.href='https://www.google.es/maps'>Cómo llegar</button></div>"    
                });
                infowindow.open(map, marker);
            });
        });
    ...
    $.getJSON("assets/jsons/aparcamientos.json", function(data) {
        $.each(data.aparcamientos, function(index, value) {
            ...
            marker.addListener('click', function() {
                //infowindow.close();//hide the infowindow --> no funciona
                infowindow.setOptions({
                    content: "<div class='text-marker'><h2>" + value.parking + " <img src='assets/img/heart-empty.png' height='15'></h2>" +
                        "<h3>" + value.direccion + "</h3>" +
                        "<p>Precio: <b>" + value.precio + "</b></p>" +
                        "<p>Nivel de seguridad: <b>" + value.niveldeseguridad + "</b></p>"+
                        "<button onclick=window.location.href='https://www.google.es/maps'>Cómo llegar</button></div>"    
    ...
    /* Aparcamientos Favoritos (reservables) */
    $.getJSON("assets/jsons/reservables.json", function(data) {
        $.each(data.reservables, function(index, value) {
            ...
            marker.addListener('click', function() {                
                //infowindow.close();//hide the infowindow --> no funciona
                infowindow.setOptions({
                    content: "<div class='text-marker'><h2>" + value.parking + " <img src='assets/img/heart.png' height='15'></h2>" +
                        "<h3>" + value.direccion + "</h3>" +
                        "<p>Precio: <b>" + value.precio + "</b></p>" +
                        "<p>Nivel de seguridad: <b>" + value.niveldeseguridad + "</b></p>" +
                        "<button onclick=window.location.href='https://www.google.es/maps'>Cómo llegar</button></div>"    
